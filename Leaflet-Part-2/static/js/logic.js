...
// To get the geoJSON API endpoint for the last week earthquake record:
// Go to this link https://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php
// Click on "All earthquakes" under the "Past 7 days" section
// Copy the URL, which is https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson
// Store the API endpoint for the last week earthquake in URL variable
let URL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";

// To get the geoJSON API endpoint for the tectonicplates:
// Go to this link https://github.com/fraxen/tectonicplates/blob/master/GeoJSON/PB2002_boundaries.json
// Click on "raw" tab on the right hand conner
// Copy the URL, which is https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json
// Store the API endpoint for the tectonicplates:
let tecnonicplatesURL = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
...
d3.json(URL).then(function (data) {
    ...
    // Retrive the geoJSON data using d3.json() function
    d3.json(tecnonicplatesURL).then(function (plates) {
